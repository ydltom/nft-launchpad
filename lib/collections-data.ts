...
export const collectionsData: { [key: string]: NFTCollection } = {
  ...
  "cosmic-dreamers": {
    ...
    image: "/imaginary-ones.webp?height=400&width=400",
  ...
  "kaidro-spirit": {
    ...
    image: "/kaidro-spirit.avif?height=400&width=400",
  ...
  "neo-tokyo": {
    ...
    image: "/neo-tokyo.avif?height=400&width=400",
